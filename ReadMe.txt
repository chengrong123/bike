...
Nine - Nine-node network;
ND - Nguyen–Dupuis network;
SF - Sioux Falls network; 

Files "auto_small.csv", "auto_ND.csv", "auto_Nine.csv", and "auto_SF.csv" present cars traveling information on the three networks.
...
Files "bike_small.csv", "bike_ND.csv","bike_Nine.csv", and "bike_SF.csv" present cycling information on the three networks.
  	For each line, it contains the following information:
    		<link>: ID of the link
    		<origin>: origin of the link
    		<destination>: destination of the link
...
Files "Small_Low_demand.csv", "Small_Med_demand.csv",  "Small_High_demand.csv",  "Nine_Low_demand.csv", "Nine_Med_demand.csv",  "Nine_High_demand.csv", "ND_Low_demand.csv", "ND_Med_demand.csv",  "ND_High_demand.csv", 
...
Files "Small_Lane_cost.csv", "ND_Lane_cost.csv", "Nine_Lane_cost.csv", and "SF_Lane_cost.csv" list the cost for builing a bike lane on each link in the three networks.
	For each line, it lists the cost for building a bike lane on the link. The link ID is equal to the row number.
  
 
Files "Small_Station_cost.csv", "Nine_Station_cost.csv",  "ND_Station_cost.csv" and "SF_Station_cost.csv" list the cost for builing a bike station close to a node in the three networks.
